...
default['memsql']['release'] = "#{default['memsql']['version']}-1.el7.ngx.x86_64"
default['memsql']['file-name'] = "nginx-#{default['memsql']['nginx-release']}.rpm"
default['memsql']['s3-path'] = "#{default['memsql']['s3-path']}/#{default['memsql']['file-name']}"
